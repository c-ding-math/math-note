...
if ( ! function_exists( 'math_note_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function math_note_posted_on() {
...
if ( ! function_exists( 'math_note_posted_by' ) ) :
	...
	function math_note_posted_by() {
		$byline = sprintf(
			...
			esc_html_x( 'posted by %s', 'post author', 'math-note' ),
...
if ( ! function_exists( 'math_note_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function math_note_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $categories_list ) {
				/* translators: 1: list of categories. */
				printf( '<span class="cat-links">' . esc_html__( 'posted in %1$s', 'math-note' ) . '</span>', $categories_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			}
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'math-note' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'math-note' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'math_note_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function math_note_post_thumbnail() {
